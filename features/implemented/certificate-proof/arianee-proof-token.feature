Feature: Arianee JWT
  ...
  Scenario: Owner of certificate creates Arianee Proof Token. User can see certificate
    ...
    And user1 creates arianeeProofToken from certificate0
    And user2 get certificate with arianeeProofToken with parameters:
          """
         {
          "content": "true"
          }
  ...
  Scenario: Not owner of certificate creates Arianee Proof Token. User cannot see certificate
    ...
    And user1 creates arianeeProofToken from certificate0
    And user3 get certificate with arianeeProofToken with parameters:
          """
         {
          "content": "true"
          }
